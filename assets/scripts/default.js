...
function testOne(row, column){
	...
	try{
		iframe.contentWindow.eval('var __timer = new Date(),__result; __times = ' + time + '; while(__times--){' + cell.text + ';} __result = new Date() - __timer;');
		time = iframe.contentWindow.__result;
